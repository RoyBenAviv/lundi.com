...
export default function Item({ isLoadingNewItem, item, columns,columnsWidth, groupWidth, boardId, groupId }: { isLoadingNewItem: boolean; item: Item; columns: Column[];   columnsWidth: any; groupWidth: number; boardId: string; groupId: string}) {
  ...
  return (
    <section className="item-row">
      ...
      {columns.map((column: Column) => {
        ...
        return (
          <ColumnValue key={column.id} column={column} columnsWidth={columnsWidth} columnValue={columnValue}  item={item} boardId={boardId} groupId={groupId}/>
        )
      })}
